...
export default function CarRentalPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://script.google.com/macros/s/AKfycbwUyVH2CJur334a6uM44ngq68sY5QU4UOLCjVC61ULqAkaaGj4d9T3p06Yrvj0J-ihkRQ/exec", {
        method: "POST",
        headers: {
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <Button variant="outline" className="w-full" asChild>
                    <Link href="/contact">Contact Rental Support</Link>
                  </Button>
                </div>
              </CardContent>
            </Card>
